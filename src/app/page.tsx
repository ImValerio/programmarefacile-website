...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between items-center p-24">
      <div>
        ...
        <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@programmarefacile" data-unique-id="programmarefacile" data-embed-type="creator" > 
          <section> 
